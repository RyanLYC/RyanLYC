...
- [Python + PyTest + Allure + Selenium3 web 自动化测试框架](https://github.com/RyanLYC/system_autotest)
...
- 保留一天数据，生成一个 demo 网站用于无网络地方展示或者固定显示那一天数据
  ...
  2. 全部页面点击一次
  3. 拦截 axios 请求，直接使用对应的接口文件(文件存放在阿里云 OSS)
- [el-table 导出为 Excel](./笔记/XLSX.md)

## [设计模式(前端常用 - TypeScript)](./设计模式/设计模式.md)
